...
export const users = mysqlTable("users", {
  ...
  emailVerifyExpiresAt: timestamp("emailVerifyExpiresAt"),
});
...
export const subscriptions = mysqlTable("subscriptions", {
  ...
  asaasSubId: varchar("asaasSubId", { length: 255 }),
...
export const invoices = mysqlTable("invoices", {
  ...
  asaasPaymentId: varchar("asaasPaymentId", { length: 255 }).notNull().unique(),
