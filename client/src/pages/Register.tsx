    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 to-amber-50">
        <div className="w-full max-w-sm px-4 text-center">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Quase lá! Verifique seu e-mail</h1>
          <p className="text-gray-500 text-sm mb-2">
            Enviamos um link de confirmação para <strong>{email}</strong>.
          </p>
          <p className="text-gray-400 text-xs mb-6">
            Clique no link para ativar sua conta e acessar o painel do restaurante{" "}
            <strong>{restaurantName}</strong> automaticamente. O link expira em 24 horas.
          </p>
      ...
      <div className="w-full max-w-md px-4">
        ...
        <Card className="shadow-xl border-0">
          <CardHeader className="pb-2">
            ...
            <CardDescription>
              Preencha os dados abaixo. Você receberá um e-mail para ativar sua conta.
            </CardDescription>
          </CardHeader>
          <CardContent>
